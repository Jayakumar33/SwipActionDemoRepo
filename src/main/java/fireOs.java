...
public class fireOs {
    ...
    public void AndroidApp1() {
        try {
            ...
            capabilities.setCapability("build", "Fireos");
            capabilities.setCapability("name", "FireOS_3");
            capabilities.setCapability("platformName", "fireos");
            capabilities.setCapability("deviceName", "Amazon Fire TV Stick");
